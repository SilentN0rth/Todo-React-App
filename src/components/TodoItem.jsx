	...
	return (
		<>
			...
			<div
				...
				className={`grid grid-cols-1 grid-rows-1 rounded-xl text-white ${gray ? ' grayscale line-through' : ''} bg-${
					matchingCategory?.color
				}-500 border-${matchingCategory?.color}-400 border-[3px] p-5 mb-3 h-full  cursor-pointer`}>
